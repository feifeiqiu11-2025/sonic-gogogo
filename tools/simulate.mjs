...
js=js.replace('// TEST_HARNESS_INSERT',readFileSync(process.env.SUITE==='challenges'?'tools/harness_challenges.mjs':'tools/harness_tail.mjs','utf8')).replace('mountAdventure(S.destination);',"mountAdventure(process.env.DESTINATION||'tour');");
